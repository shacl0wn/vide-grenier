        ...
        <main id="programation" class="boxSite">
            ...
            <form method="post" action="verif_prog_vg.php" id="progDB">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="addresse" id="addresse" placeholder="Esplanade de la Gravière, Avenue De Limburg">
                </div>
                <div class="form-group">
                    <label for="cp">*Code postal:</label>
                    <input type="text" class="form-control" name="cp" id="cp" placeholder="69110">
                </div>
                <div class="from-group">
                    <label for="city">*Ville:</label>
                    <input type="text" class="form-control" name="ville" id="ville" placeholder="Sainte-foy-lès-lyon">
                </div>
                <div class="form-group">
