...
?>
    ...
    <body>
        ...
        try {
            ...
            $select_vg =  "SELECT * FROM vide_grenier WHERE id_vg = :id_vg";
            ...
            while ($ligne = $resultat_select->fetch()) {
                ...
                $addresse = $ligne['adr_vg'];
                $cp = $ligne['cp_vg'];
                $ville = $ligne['ville_vg'];
                $nombre = $ligne['nbEmpl_vg'];
                $restant = $ligne['nbEmplRestant_vg'];
        ...
        <main id="programation" class="boxSite">
            ...
            <form method="post" action="verif_update_vg.php?idVG=<?php echo $id_vg ?>" id="progDB">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="<?php echo $cp ?>" name="cp" id="cp" placeholder="Sainte-foy-lès-lyon">
                </div>
                <div class="form-group">
                    <label for="ville">*Ville: </label>
                    <input type="text" class="form-control" value="<?php echo $ville ?>" name="ville" id="ville" placeholder="Sainte-foy-lès-lyon">
                </div>
                <div class="form-group">
