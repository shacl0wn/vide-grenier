    ...
    <body>
        ...
        <main id="suppMl">
            ...
            try {
                ...
                //Nouvelle partie avec procédure stocké
                $resultat_delete = $base->prepare("CALL delete_user_mailing_list_by_id(?)");
                $delete = $_POST['choix_ml'];
                $resultat_delete->bindParam(1, $delete, PDO::PARAM_INT);
                $resultat_delete->execute();
                $resultat_delete->closeCursor();
